...
export const AboutText = () => {
    return (
        <div className="container-2 flex flex-col items-center max-md:pt-8 max-md:px-4 max-md:mb-8">
            ...
            <p className="tracking-tighter mt-4 mb-2 text-xl max-md:px-4 max-md:text-base max-md:my-2 px-8 max-md:tracking-wide leading-relaxed">
            ...
            <p className="tracking-tighter my-2 text-xl max-md:px-4 max-md:text-base max-md:my-2 px-8 max-md:tracking-wide">
